...
- **최소 지식 원칙**
    - 객체 사이의 상호작용은 가장 가까운 객체끼리만 허용하는 편이 좋음
        - 객체 자체, 메소드 매개변수 객체, 메소드를 생성하거나 인스턴스를 만든 객체, 객체에 속하는 구성 요소

# [8장] 알고리즘 캡슐화하기
- **템플릿 메소드 패턴**
    - 알고리즘의 각 단계와 공통적인 메소드는 슈퍼클래스에서 구현하고 일부 단계를 서브클래스에서 구현(추상메소드)
    - 간단하게 말해서 알고리즘의 템플릿임
    - 후크란 추상 클래스에서 선언되지만 기본적인 내용만 구현되어 있거나 아무 내용도 없는 메소드
        - 서브클래스에서 후크를 오버라이드 해서 사용, if문 등에서 사용
